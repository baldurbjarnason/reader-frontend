...
import { useContext, useState, useEffect } from 'haunted'
...
export const render = () => {
  ...
  <ink-button @click=${event => {
    opener('ink-uploader-modal', {}, null, event.target)
...
export const modalRender = () => {
  ...
  <icon-button name="cancel" @click=${() => closer()}>Close Menu</icon-button>
...
createModal('ink-uploader-modal', modalRender, { popper: true })
